  ...
  return (
    <div className="music-app">
      <section className="now-playing">
        ...
        <span>GLOBAL KY MIX · 22 TRACKS</span><h2>{current?.trackName ?? "Loading music…"}</h2><p>{current?.artistName ?? "English · Korean · Japanese · Chinese · French"}</p>
        ...
        <small>30-second previews courtesy of Apple iTunes. The next track starts automatically.</small>
      </section>
